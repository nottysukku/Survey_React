        ...
        if (type === 'checkbox') {
            setFormData(prev => {
                const updatedFood = checked 
                    ? [...prev.food, value] 
                    : prev.food.filter(item => item !== value);
                            ...
                            <fieldset className="space-y-2">
                                ...
                                <label className="block">
                                    <input
                                        ...
                                        type="radio" 
                                        value="Vegetarian"  
                                        checked={formData.eating_style === 'Vegetarian'}
                                        className="mr-2" 
                                        required 
                                    /> Vegetarian
                                </label>
                                <label className="block">
                                    <input 
                                        ...
                                        onChange={handleChange} 
                                        name="eating_style" 
                                        checked={formData.eating_style === 'Non-Vegetarian'}
                                        className="mr-2" 
                                    /> Non-Vegetarian
                                </label>
                            </fieldset>
                            ...
                            <fieldset className="space-y-2">
                                ...
                                <label className="block">
                                    <input 
                                        ...
                                        name='food'
                                        type="checkbox"  
                                        checked={formData.food.includes('Burger')} 
                                        className="mr-2" 
                                    /> Burger
                                </label>
                                <label className="block">
                                    <input 
                                        ...
                                        name='food'
                                        type="checkbox" 
                                        checked={formData.food.includes('Pizza')}
                                        className="mr-2" 
                                    /> Pizza
                                </label>
                            </fieldset>
